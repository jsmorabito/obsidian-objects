...
var ShortcutsSettingTab = class extends import_obsidian7.PluginSettingTab {
  ...
  createGeneralSettings(containerEl) {
    ...
    new import_obsidian7.Setting(containerEl).setName("Focus key").setDesc(`While in shortcut mode, pressing this key restores focus to the editor (inspired by Vim's "i" for insert mode). Leave blank to disable \u2014 useful if you want to use "i" in shortcut sequences and already have another way to exit shortcut mode (e.g. Esc).`).addText((text) => {
      var _a;
      text.setPlaceholder("i").setValue((_a = this.plugin.settings.focusKey) != null ? _a : "").onChange((value) => {
